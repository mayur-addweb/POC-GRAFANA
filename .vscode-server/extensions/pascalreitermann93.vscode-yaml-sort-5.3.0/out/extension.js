...
exports.isSelectionInvalid = exports.sortYamlFiles = exports.formatYaml = exports.formatYamlWrapper = exports.validateYaml = exports.validateYamlWrapper = exports.sortYaml = exports.sortYamlWrapper = exports.applyEdits = exports.getCustomSortKeywords = exports.dumpYaml = exports.activate = void 0;
...
function activate(context) {
    const formatter = {
        provideDocumentFormattingEdits() {
            const sortOnSave = vscode.workspace.getConfiguration().get('vscode-yaml-sort.sortOnSave');
 ...
 */
function applyEdits(activeEditor, edits) {
    if (activeEditor) {
